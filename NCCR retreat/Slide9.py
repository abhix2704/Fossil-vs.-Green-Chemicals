...
ax.set_title("Ammonia [USD kg$^\mathrm{-1}$ CO$_\mathrm{2}$-eq]", fontsize = 14, fontweight = "bold")
...
for i, label in enumerate(ax.get_xticklabels()):
    ...
    label.set_position((angle, 0.05))  # Adjust the position of the labels
    
# Draw ylabels
plt.yticks([0,0.5,1,1.5], ["","0.5","1","1.5"], color="black")
plt.ylim(-1,1.5)
...
ax.set_title("Methanol [USD kg$^\mathrm{-1}$ CO$_\mathrm{2}$-eq]", fontsize = 14, fontweight = "bold")
ax.set_theta_offset(pi/2)  # shift 90 degrees
ax.set_theta_direction(-1)  # clockwise
ax.set_thetamax(36)
ax.patch.set_facecolor("#ffffff")
...
# Draw ylabels
plt.yticks([0,3,6,9], ["","3","6","9"], color="black")
plt.ylim(-6,9)
...
plt.savefig('Slide 9.svg', dpi=600, bbox_inches='tight')
plt.savefig('Slide 9.jpg', dpi=600, bbox_inches='tight')
