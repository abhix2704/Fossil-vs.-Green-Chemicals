...
fig = plt.figure(figsize=(fig_length[2]*1.5,fig_height*0.6))
...
#           prop={"size":12}, bbox_to_anchor=(0.5, 0.05), handletextpad = 0.1)


plt.savefig('Slide 3.png', dpi=600, format='jpg', bbox_inches="tight")
plt.savefig('Slide 3.svg', dpi=600, format='svg', bbox_inches="tight")
