...
#plt.plot([41.5]*len(ylist), ylist, color = "grey", linewidth = 0.2, linestyle = "--", zorder = 0)
#plt.plot(index[0:l], market[0:l], "--", color = "brown", linewidth = 2)
plt.plot(index[0:31], NGprices[0:31], color = "#808080", linewidth = 1.5, zorder = 0, linestyle = "--")
#plt.plot(index[NGindex], BAUprices[NGindex], color = "black", linewidth = 2, zorder = 1, linestyle = "-")
plt.scatter(index[0:31], NGprices[0:31], marker = "o", facecolors = '#808080', edgecolors = "none", s = 20, zorder = 2)
...
plt.ylim(0,max(NGprices)+0.2)
ax.yaxis.set_minor_locator(tk.AutoMinorLocator(2))
plt.ylabel("Natural gas price [USD kg$^\mathrm{-1}$]")


plt.savefig('Slide 2b.png', dpi=600, format='jpg', bbox_inches="tight")
plt.savefig('Slide 2b.svg', dpi=600, format='svg', bbox_inches="tight")
