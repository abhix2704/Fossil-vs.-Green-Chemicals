...
plt.ylabel("Price [USD kWh$^\mathrm{-1}$]")
ax = plt.gca()
...
plt.savefig('Figure S1.png', dpi=600, format='jpg', bbox_inches="tight")
plt.savefig('Figure S1.svg', dpi=600, format='svg', bbox_inches="tight")
