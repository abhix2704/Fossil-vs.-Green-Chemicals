...
#plt.plot(index, NGprices, color = "#808080", linewidth = 1, zorder = 0)
#plt.plot(index, BAUprices, color = "black", linewidth = 2, zorder = 1, linestyle = "-")
plt.scatter(index, NGprices, marker = "o", facecolors = '#808080', edgecolors = "none", s = 15, zorder = 2)
plt.scatter(index, BAUprices, facecolors = "#ffffff", edgecolors = "black", marker = "s", s = 15, zorder = 3)
...
#plt.plot(index, BAUprices, color = "black", linewidth = 2, zorder = 1, linestyle = "-")
plt.scatter(index, NGprices, marker = "o", facecolors = '#808080', edgecolors = "none", s = 15, zorder = 2)
plt.scatter(index, BAUprices, facecolors = "#ffffff", edgecolors = "black", marker = "D", s = 15, zorder = 3)
...
plt.savefig('Figure 1a.jpg', dpi=600, format='jpg', bbox_inches="tight")
plt.savefig('Figure 1a.svg', dpi=600, format='svg', bbox_inches="tight")
