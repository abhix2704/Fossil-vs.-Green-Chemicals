...
ax.set_title("d Methanol [USD kg$^\mathrm{-1}$]", fontsize = fontsize_title, fontweight = "bold")
ax.set_theta_offset(pi/2)  # shift 90 degrees
ax.set_theta_direction(-1)  # clockwise
ax.set_thetamax(36)
ax.patch.set_facecolor("#ffffff")
...
plt.savefig('Figure 2 (radar).jpg', dpi=600, format='jpg', bbox_inches="tight")
plt.savefig('Figure 2 (radar).svg', dpi=600, format='svg', bbox_inches="tight")
