...
plt.text(NGprices[xmax/100] - 1300, windPrices1[len(windPrices1) - 1] - 400, "DAC + wind electrolysis + BAU ethylene", 
         color = "blue", rotation = 12.5)
plt.text(NGprices[xmax/100] - 2400, windPrices1[len(windPrices1) - 1] + 400, "DAC + wind electrolysis + green ethylene", 
         color = "green", rotation = 28.5)
